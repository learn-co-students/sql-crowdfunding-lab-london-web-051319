...
"SELECT users.name, SUM(pledges.amount) FROM projects INNER JOIN pledges ON projects.id = pledges.project_id INNER JOIN users ON users.id = pledges.user_id GROUP BY users.name ORDER BY SUM(pledges.amount)";
end
